...
# Hàm kết thúc game
def game_over():
    # Thiết lập phông chữ dòng thông báo kết thúc
    my_font = pygame.font.SysFont('Jumble', 80)

    # Viết dòng thông báo kết thúc
    game_over_message1 = my_font.render('!!Congratulation!!', True, green)
    game_over_message2 = my_font.render(
    'Your Score is : ' + str(score), True, white)

    # Tạo khối hcn cho thông báo kết thúc
    game_over_rect1 = game_over_message1.get_rect()
    game_over_rect2 = game_over_message2.get_rect()

    # Thiết lập vị trí của thông báo kết thúc
    game_over_rect1.midtop = (window_x / 2, window_y / 4)
    game_over_rect2.midtop = (360, 180)

    # blit sẽ hiện thông báo kết thúc trên màn hình
    game_window.blit(game_over_message1, game_over_rect1)
    game_window.blit(game_over_message2, game_over_rect2)
    pygame.display.flip()
    while True:
